package com.blizzard.war.mvp.model.home.Hot;
...
import com.blizzard.war.mvp.ui.adapter.pager.HotAdapter;
 ...
 */
public class HotView extends RxLazyFragment {
    ...
    public static HotView newInstance() {
        return new HotView();
    }
    ...
    protected void initRecyclerView() {
        ...
        layout.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
            ...
            public int getSpanSize(int i) {
                return mHotAdapter.getSpanSize(i);
            }
        });
