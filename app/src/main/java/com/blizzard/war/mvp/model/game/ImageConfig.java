...
public final class ImageConfig {
    ...
    public static List<String> getUrls() {
        ...
        sUrls.add("http://pic.qiantucdn.com/58pic/11/90/83/96a58PICrRx.jpg");
...
//        sUrls.add("http://img44.photophoto.cn/20170729/0847085226124343_s.jpg");
    ...
    public static List<UserViewInfo> getGifUrls() {
        ...
        userViewInfos.add(new UserViewInfo("http://img.soogif.com/8Q8Vy8jh6wEYCT4bYiEAOZdmzIf7GrLQ.gif_s400x0"));
        userViewInfos.add(new UserViewInfo("http://img.soogif.com/yCPIVl3icfbIhZ1rjKKU6Kl6lCKkC8Wq.gif_s400x0"));
        userViewInfos.add(new UserViewInfo("http://img.soogif.com/mQK3vlOYVOIpnhNYKg6XuWqpc3yAg9hR.gif_s400x0"));
        userViewInfos.add(new UserViewInfo("http://img.soogif.com/mESQBeZn5V8Xzke0XPsnEEXUF9MaU3sA.gif_s400x0"));
        userViewInfos.add(new UserViewInfo("http://img.soogif.com/HFuVvydFj7dgIEcbEBMA9ccGcGOFdEsx.gif_s400x0"));
